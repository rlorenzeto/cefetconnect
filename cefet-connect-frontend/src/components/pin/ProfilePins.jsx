...
export default function ProfilePins({
  ...
  return (
    <section className="mt-7 min-w-0 max-w-full overflow-hidden rounded-[28px] bg-[#f7f7f7] px-5 py-5">
      <div className="mb-4 flex min-w-0 items-start justify-between gap-3">
        ...
        {isOwnProfile && (
          <button
            ...
            className="shrink-0 rounded-full bg-[#089464] px-4 py-2 text-xs font-bold text-white transition hover:bg-[#067f57]"
          >
            Adicionar pin
          </button>
        )}
