...
export const ErrorMessages = {
  ...
  // ── Ícone ─────────────────────────────────────────────────────────────────
  EICO00001: { mensagem: 'Conta não conectada ao Gradment. Por favor, conecte sua conta antes de importar ícones.', status: 400 },
  EICO00002: { mensagem: 'Não foi possível conectar ao Gradment. Verifique se sua conta está vinculada.', status: 400 },
